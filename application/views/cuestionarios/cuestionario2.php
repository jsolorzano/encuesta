						...
						<div class="col-xs-12">
							...
							<div class="box box-primary">
								<div class="box-body">
									...
									<form id="form_encuesta1">
										<?php $i = 1;?>
										<?php foreach ($preguntas1 as $pregunta) {?>
										<div class="col-md-6">
											<div class="form-group">
												...
												<select id="respuesta_<?php echo $i;?>" name="respuesta_<?php echo $i;?>" class="form-control select2" >
													...
													<?php foreach ($respuestas1 as $respuesta) {?>
										...
										<div class="col-md-2">
											<div class="form-group">
												<br>
												<button type="button" id="agregar2" style="font-weight: bold;font-size: 13px" class="btn btn-primary " >
													&nbsp;<span class="glyphicon glyphicon-floppy-disk"></span>&nbsp;Guardar y continuar
												</button>
												<input id="id" name="id" type='hidden' value="<?php echo $encuesta1[0]->id; ?>" class="form-control" >
												<input id="codigo" name="codigo" type='hidden' value="<?php echo $encuesta1[0]->codigo; ?>" class="form-control" >
												...
												<input class="form-control" type='hidden' id="usuario_id" name="usuario_id" value="<?php echo $encuesta1[0]->usuario_id; ?>"/>
...
<script>
    ...
    $('#agregar2').click(function(e){
        ...
        if($("#campos_vacios").val() == 0){
			$.post('<?php echo base_url(); ?>index.php/cuestionarios/ControllersEncuesta1/actualizar', $('#form_encuesta1').serialize(), function (response){
				
				bootbox.alert("Se actualizó su encuesta con Exito ", function (){
					window.location = '<?php echo base_url(); ?>index.php/cuestionarios/ControllersEncuesta2/'
				});
