...
//~ 
                ...
                $("#respuesta").change(function (event) {
                    ...
                    $.post('<?php echo base_url(); ?>index.php/respuestas_parte_1/ControllersRespuestas1/consultar/', $('#form_respuesta').serialize(), function (response) {
						//~ alert(response[0])
						if (response[0] == 'e') {
                ...
                $("#registrar").click(function (e) {
                    ...
                    //~ }
                         ...
                         $.post('<?php echo base_url(); ?>index.php/respuestas_parte_1/ControllersRespuestas1/guardar', $('#form_respuesta').serialize(), function (response) {
