...
<?php if ($tipouser == 'Administrador'){
    ...
    <script>
        $(document).ready(function () {
            var TTRespuestas1 = $('#tab_respuestas1').dataTable({
                "iDisplayLength": 10,
                "iDisplayStart": 0,
			...
			$("table#tab_respuestas1").on('click', 'input.activar_desactivar', function (e) {
				e.preventDefault();
				...
				bootbox.confirm("¿Desea "+accion+" la respuesta?", function(result) {
					if (result) {
						...
						$.post('<?php echo base_url(); ?>index.php/respuestas_parte_1/ControllersRespuestas1/activar_desactivar/' + id, {'accion':accion}, function(response) {
            ...
            $('#enviar').click(function () {
                url = '<?php echo base_url() ?>index.php/respuestas_parte_1/ControllersRespuestas1/registrar';
                window.location = url;
            });
            ...
            <div class="container" style="width:90%;">
                <div class="row">
                    ...
                    <div class="page-header">
                        <h3 id="tables" class="lista">Listado de Respuestas de la Parte 1</h3>
                    </div>

                    <table style="width:100%;" border="0" align="center" cellspacing="1" id="tab_respuestas1" align="center"
                            ...
                            <?php foreach ($listar as $respuesta) { ?>
                                <tr style="font-size: 16px;text-align: center" class="{% cycle 'impar' 'par' %}" >
                                    ...
                                    <td style='text-align: center'>
                                        <a title="Editar" href="<?php echo base_url() ?>index.php/respuestas_parte_1/ControllersRespuestas1/editar/<?= $respuesta->id; ?>"><i class="glyphicon glyphicon-edit"></i></a>
                                    </td>
                                    <td style='text-align: center'>
