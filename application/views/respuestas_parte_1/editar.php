        ...
        <script>
            $(document).ready(function () {
                ...
                $('#volver').click(function () {
                    url = '<?php echo base_url()?>index.php/respuestas_parte_1/ControllersRespuestas1'
                    window.location = url
                })
...
//~ 
                ...
                $("#registrar").click(function (e) {
                    ...
                    //~ }
                         ...
                         $.post('<?php echo base_url(); ?>index.php/respuestas_parte_1/ControllersRespuestas1/actualizar', $('#form_respuesta').serialize(), function (response) {
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                           ...
                                           <div class="col-xs-1" style="font-weight:bold">Respuesta</div>
                                            <div class="col-lg-5">
                                               	<input class="form-control" type='text' placeholder="Descripción de la respuesta" value="<?php echo $editar[0]->respuesta?>" id="respuesta" name="respuesta"/>
                                            </div>
