        ...
        <script>
            $(document).ready(function () {
                ...
                $("#registrar").click(function (e) {
                    ...
                    //~ var RegExPattern = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[$@$!%*?&])[A-Za-z\d$@$!%*?&]{8,12}/;  // Expresión regular para validar contraseña segura (primera opción: Entre 8 y 10 caracteres, por lo menos un digito y un alfanumérico, y no puede contener caracteres espaciales)
                    var RegExPattern = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[$@$!%*?&])[A-Za-z\d$@$!%*?&]{8,12}/;  // Nueva opción 1 (Minimo 8 caracteres, maximo 15, al menos una letra mayúscula, al menos una letra minucula, al menos un dígito, no espacios en blanco, al menos 1 caracter especial)
                    //~ var RegExPattern = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[$@$!%*?&#.$($)$-$_‌​])[A-Za-z\d$@$!%*?&a‌​mp;#.$($)$-$_]{8,12}‌​$/;  // Nueva opción 2 con más caracteres especiales(Minimo 8 caracteres, maximo 15, al menos una letra mayúscula, al menos una letra minucula, al menos un dígito, no espacios en blanco, al menos 1 caracter especial)
                    ...
                    if ($('#username').val().trim() == '') {
                        ...
                        bootbox.alert("El campo clave de acceso no puede estar en blanco", function () {
                        }).on('hidden.bs.modal', function (event) {
