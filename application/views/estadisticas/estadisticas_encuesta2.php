		...
		<div class="container" style="width:90%;">
			<div class="row">
				...
				<section class="content-header text-center">
					<h1 style="color:#fff">
						ESTADÍSTICAS DEL CUESTIONARIO DE LA ESCALA LICKERT
					</h1>
				</section>
							...
							<div class="box box-primary text-left">
								<div class="box-body">
									<div class="page-header text-left">
										<h4 class="lista">A continuación se exponen una serie de estadísticas correspondientes a cada pregunta del cuestionario de la Escala Lickert.</h4>
									</div>
