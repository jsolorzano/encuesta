...
//~ 
                ...
                $("#pregunta").change(function (event) {
                    ...
                    $.post('<?php echo base_url(); ?>index.php/preguntas_parte_1/ControllersPreguntas1/consultar/', $('#form_pregunta').serialize(), function (response) {
						//~ alert(response[0])
						if (response[0] == 'e') {
                ...
                $("#registrar").click(function (e) {
                    ...
                    //~ }
                         ...
                         $.post('<?php echo base_url(); ?>index.php/preguntas_parte_1/ControllersPreguntas1/guardar', $('#form_pregunta').serialize(), function (response) {
