...
class ModelsPreguntas1 extends CI_Model {
    //put your code here
    ...
    public function obtenerPreguntas() {
        ...
        $query = $this->db->get('preguntas_parte_1');
    ...
    public function insertarPregunta($datos)
    {
        ...
        $result = $this->db->insert("preguntas_parte_1", $datos);
        return $result;
    }
    ...
    public function actualizarPregunta($datos) {
        ...
        $result = $this->db->update('preguntas_parte_1', $datos);
        return $result;
