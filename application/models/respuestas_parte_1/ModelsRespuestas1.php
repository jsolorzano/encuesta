...
class ModelsRespuestas1 extends CI_Model {
    //put your code here
    ...
    public function obtenerRespuestas() {
        ...
        $query = $this->db->get('respuestas_parte_1');
    ...
    public function insertarRespuesta($datos)
    {
        ...
        $result = $this->db->insert("respuestas_parte_1", $datos);
        return $result;
    }
    ...
    public function actualizarRespuesta($datos) {
        ...
        $result = $this->db->update('respuestas_parte_1', $datos);
        return $result;
